...
const SettingsModal = ({ isOpen, onClose }) => {
  ...
  const testApiKey = async () => {
    ...
    try {
      const res = await tmdbService.getTrending(apiKey);
      setTestStatus(res.results?.length > 0 ? '✓ API key is valid!' : '✗ Invalid API key');
        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="space-y-3">
              <input type="text" placeholder="Enter your TMDB API key" value={apiKey}
