      ...
      <div className="flex items-center justify-between px-4 md:px-12 py-4">
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            ...
            <input type="text" placeholder="Search..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-10 pr-4 py-2 bg-gray-900 border border-gray-700 rounded text-sm focus:outline-none focus:border-white" />
          </div>
          <button onClick={onOpenSettings} className="p-2 hover:bg-gray-800 rounded transition"><Settings className="w-5 h-5" /></button>
